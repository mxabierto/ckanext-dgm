this.ckan.module('recline_view', function (jQuery, _) {
  return {
    options: {
      i18n: {
        errorLoadingPreview: "No se puede cargar la vista",
        errorDataProxy: "DataProxy regresó un error",
        errorDataStore: "DataStore regresó un error",
        previewNotAvailableForDataType: "Vista no disponible para el tipo de dato: "
      },
      site_url: "",
